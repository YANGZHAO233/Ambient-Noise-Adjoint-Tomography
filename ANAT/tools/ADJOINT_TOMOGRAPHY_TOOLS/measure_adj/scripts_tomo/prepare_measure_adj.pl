...
$ENV{'SACAUX'}='/home/ose-guoz/sac/sac/aux';
...
# CMTSOLUTION file
$dir_cmt = "../solver/$smodel/$eid/DATA";
...
$cshfile = "prepare_measure_adj.sh";
print "\nWriting to $cshfile ...\n";
open(CSH,">$cshfile");
...
if ($iplot == 1) {
  ...
  print CSH "\\rm -f PLOTS/*pdf PLOTS/*jpg PLOTS/*ps\n";
...
$par_out = "./PAR_FILE";
print CSH "\\rm -f ${win_out}\n";
print CSH "\\cp ${win_in} ${win_out}\n";
print CSH "\\rm -f ${par_out}\n";
