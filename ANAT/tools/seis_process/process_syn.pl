...
Revised:
add -n for normalization records
    Kai Wang, Feb 2016
END
exit(1);
}
...
if (!getopts('Sm:ho:l:t:fi:npP:a:cd:x:vs:y:A:')) {die(" check input arguments\n");}
